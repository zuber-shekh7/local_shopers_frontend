...
const Footer = () => {
  return (
    <footer>
      <section className="bg-indigo-600 grid grid-cols-1 md:grid-cols-3 gap-x-5 md:justify-items-center pb-5 md:pb-0">
        ...
        <div className="px-5 pt-5 md:p-10">
          ...
          <div className="text-white">
            ...
            <Link className="block" to={routes.privacyPolicy}>
              Privacy Policy
            </Link>
            <Link className="block" to={routes.termsOfService}>
              Terms of Service
            </Link>
            <Link className="block" to={routes.contact}>
              Contact Us
            </Link>
            <Link className="block" to={routes.faq}>
              FAQs
            </Link>
          </div>
        </div>
